...
Try {
	...
	[string]$appName = 'Ellucian Recruiter Hotfix'
	[string]$appVersion = '1.0'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '04/24/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$HotfixInstalled = Test-MSUpdates -KBNumber 'KB4016446'
		...
		If (-not $HotfixInstalled) {
			If ($envOSVersion -like "6.1*") {
				Install-MSUpdates -Directory "$dirFiles\Windows7-x64"
			}
			If ($envOSVersion -like "6.3*") {
				Install-MSUpdates -Directory "$dirFiles\Windows8.1-x64"
			}
		}
		...
		Set-RegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\MSUDenver" -Name "KB4016446" -Value "1" -Type "DWord" -ContinueOnError $true
		Execute-ProcessAsUser -Path "$envProgramFilesX86\Internet Explorer\iexplore.exe" -Parameters "https://recruiter.msudenver.edu/default.aspx" -ContinueOnError $true
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDwdWuovOFJ7IM/
# 3Sr2DmKbhSGx6tL/wSqjhuuhyVgI6qCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIF74
# 0GR/C4KZExgIpun3hK+WjB2/XLgu6xiIYwCIeesdMA0GCSqGSIb3DQEBAQUABIIB
# ADvlzjSpNqy10BOnxAqDZTS1JgqTBwpNAOnQLF0iHpCOic1W12ujT/SZgD7xZdxL
# UItU/0c+d2ioi1gKaVnK07hh0yTj+Tf81gD+shUC34Syfua9crMjGC3BCAxils2x
# AcmnJORcBaCGyNGTPkB0ujT4dsulbmF9tT5hbJQ+j43fff+AftwTGS03HMQqOTRi
# 0WsZr5KHP+fLbw01ok4Mzeqg1mAFPBKLMqH6gxGrBrrJns4Q3iqvbQf/DvJYROdv
# CUTNfk8NqXTms9AeOKeU4z+5GaZaXaoXfAj28BjVS2Ui+GYd+IHZXIYFoqnDwF6S
# JRh5psgkbbj5Wcm/Swmyo9ehggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwNDI1MTQ1MzA0WjAjBgkqhkiG9w0BCQQxFgQU
# /VehN8pJK0sROuugkrK9cc6h6f4wgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAIYfdtPk9pjoyGhLWgCoTOvy0IXEEACeiNH2wZtpzWrEuFh+eK8yOVEx
# 0wzMHBmx68oq3HRpLnwoVt1Jz8M99TKTEas9H7TNUZXh6Hliekg+QYDQVHPckARO
# ctZ0l+IjX2ijmOSayfo/QCokCi0pg9g7Khb+PtHVQO7fsmI3X3eCX3ChHhccQPs5
# n4iV2sGC8iEKu/7bbokL0tfM+yTbrsXjo2m49pPolh059gOEHjfakSVHvHCaI7Yx
# ZW4wRPN02TQdHefdtKbozBVV6xIXEuGdKaU/gwU89DjEDWlsQxBtCIJPLNS+OU8q
# 7HeGLqATyKlH3kt0DPuZ/+af4W8jb04=
